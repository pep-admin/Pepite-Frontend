  ...
  return (
    <>
      <Box sx={{ backgroundColor: '#052525'}}>
        ...
        <HomeNav homeSectionIndex={homeSectionIndex} setHomeSectionIndex={setHomeSectionIndex} />
      </Box>
      <Container
      ...
      >
        ...
        >
          <HomeSection homeSectionRef={homeSectionRef} movies={[...movies, ...loadingMovies]} /> {/* Combine les films déjà chargés et les placeholders */}
        </InfiniteScroll>
      </Container>
    </>
  );
