...
import { styled, Paper, Container, Stack, Box, Typography, Menu, MenuItem, Button, Fade, Rating } from '@mui/material';
  ...
  return (
    <>
      ...
      <Container maxWidth="xl" sx={{backgroundColor: '#F4F4F4'}}>
        <Stack spacing={2} sx={{ padding: '10px 0 25px 0'}}>
          <SearchBar Item={Item} />
          <Box>
            <Item sx={{ 
              ...
              <Typography variant='body1' sx={{ color: '#fefefe' }}>
                Filtrer par
              </Typography>
