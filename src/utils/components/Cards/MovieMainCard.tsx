...
const MovieMainCard = ({
  ...
  const release_date =
    isMovieOrSerie === 'movie' ? movie.release_date : movie.first_air_date;
  ...
  return (
    <Stack
      marginTop={
        (movie.is_gold_nugget || movie.is_turnip) &&
        displayGradient &&
        !isFirstCard
          ? '0 !important'
          : '18px'
      ...
      sx={{
        background:
          movie.is_gold_nugget && displayGradient
    ...
    >
      <Stack padding="0 5vw">
        ...
        >
          ...
          >
            <Stack padding="0 0 0 15px">
              ...
              <Typography fontSize="0.9em" color="gray">
                {`${convertDate('year', release_date)}`}
              </Typography>
              <Typography fontSize="0.9em" color="secondary.light">
        ...
        {!isLastCard && (
          <Divider
            sx={{ borderColor: '#173333', zIndex: 100, marginTop: '18px' }}
          />
        )}
      </Stack>
    </Stack>
