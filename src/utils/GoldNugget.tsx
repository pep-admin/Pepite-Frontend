...
const useTranslateAnimation = (setIsNuggetAnimEnded) => useSpring({
...
const useShineAnimation = () => useSpring({
  ...
  return (
    ...
    >
      <AnimatedBox
        ...
        style={translate} 
        overflow='hidden' 
        sx={{clipPath: 'polygon(76% 22%, 84% 40%, 72% 73%, 64% 80%, 47% 82%, 32% 81%, 20% 75%, 15% 66%, 16% 50%, 23% 37%, 44% 19%, 62% 18%)'}}
        >
        <GoldNuggetIcon sx={{ fontSize: '6em', position: 'relative', top: '1px', right: '1px'}} />
        <AnimatedBox style={shine}
          position='absolute' 
          top='0' left='0' 
          height='100%' 
          width='35px' 
