      ...
      {isPlaceholder ?
        ...
        <Box
          sx={{
            ...
            width: '100%',
            height: '100%',
            background: homeSectionRef.current === 'popular' ? 
        ...
        >
          {
            ...
            <Stack height='100%' justifyContent='flex-end' alignItems='flex-start' padding='5px 5px 4px 5px'>
              {/* <Avatar 
                variant='rounded'
              ...
              <Stack direction='row' width='100%' justifyContent='space-between'>
                {
                  homeSectionRef.current === 'upcoming' ?
                    <Stack direction='row' width='100%' justifyContent='space-evenly' alignItems='flex-end'>
                      <CalendarMonthIcon sx={{ fontSize: '18px', color: '#bdbdbd' }} />
                      <Typography fontSize='0.8em' fontWeight='400' lineHeight='1' sx={{ color: '#bdbdbd' }}>
                  ...
                  <>
                    <Stack direction='row'>
                      ...
                      <Typography fontSize='0.8em' fontWeight='500' sx={{ color: '#e4e4e4' }}>
